...
build_ui :: proc(ctx: ^cu.Core_Context, tick_image: Image, aaloo_image: Image, width, height: f32) {
	...
	grow_1 := cu.create_widget(ctx, "child 1", cu.layout(cu.sizing(cu.grow(), cu.grow())), {}, {.Lock_Active}, style = cu.style(SURFACE_COLOR))
